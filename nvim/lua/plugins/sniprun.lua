...
return {
	{
		...
		branch = "master",
		build = "sh install.sh",
		-- Run 'sh install.sh 1' if you want to force compile locally
		...
		config = function()
			...
			vim.api.nvim_set_keymap("v", "<leader>r", "<Plug>SnipRun", opts)
			vim.api.nvim_set_keymap("n", "<leader>r", "<Plug>SnipRun", opts)
			vim.api.nvim_set_keymap("n", "<leader>f", "<Plug>SnipRunOperator", opts)
		end,
	},
}
